...
internal class BlazorNotificationService : ISystemNotificationService, IAsyncDisposable
{
    ...
    public BlazorNotificationService(IJSRuntime jSRuntime, IEnumerable<NotificationChannel>? channels = null)
    {
    ...
    private DotNetObjectReference<BlazorNotificationService>? _dotNetRef;
