...
public delegate object ViewFactory(IServiceProvider serviceProvider, params object[] parameters);
...
public interface IIocContainer
{
    ...
    void Register<T>(Func<IServiceProvider, object[], object> factory);

    void Register<TContextFor>(Func<IServiceProvider, object[], TContextFor> factory) where TContextFor : IContextFor;
