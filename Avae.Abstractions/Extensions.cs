namespace Avae.Abstractions
{
    ...
    {
        public static Task<TResult?> ShowDialogAsync<TViewModel, TResult>(this IViewModelBase viewModelBase, params object[] viewParameters) where TViewModel : IViewModelBase
        {
            var vm = SimpleProvider.GetViewModel<TViewModel>();
            return ShowDialogAsync<TViewModel, TResult>(vm, viewParameters);
        }

        public static Task<TResult?> ShowDialogAsync<TViewModel, TResult>(this IViewModelBase viewModelBase, object[] viewModelsParameters, params object[] viewParameters) where TViewModel : IViewModelBase
        {
