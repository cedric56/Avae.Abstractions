...
namespace Example
{
    public class PointerWheelChangedBehavior : AvaloniaObject
    {
        ...
        public static readonly AttachedProperty<ICommand> CommandProperty = AvaloniaProperty.RegisterAttached<PointerWheelChangedBehavior, Interactive, ICommand>(
        ...
        public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<PointerWheelChangedBehavior, Interactive, object>(
        ...
        private static void HandleCommandChanged(Interactive interactElem, AvaloniaPropertyChangedEventArgs args)
        {
            ...
            {
                // Add non-null value
                interactElem.AddHandler(InputElement.PointerWheelChangedEvent, Handler);
            }
            else
            {
                // remove prev value
                interactElem.RemoveHandler(InputElement.PointerWheelChangedEvent, Handler);
            }
            // local handler fcn
            void Handler(ItemsControl sender, PointerWheelEventArgs e)
            {
