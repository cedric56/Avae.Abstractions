...
public static class Extensions
{
    public static void RegisterBlazorEssentials(this IServiceCollection services)
    {
        ...
        services.TryAddScoped<IClipboard>(_ => Clipboard.Default);
        ...
        services.TryAddScoped<ILauncher>(_ => Launcher.Default);
        services.TryAddScoped<IMagnetometer>(_ => Magnetometer.Default);
        services.TryAddScoped<IMap>(_ => Map.Default);
        services.TryAddScoped<IMediaPicker>(_ => MediaPicker.Default);
        ...
        services.TryAddScoped<IShare>(_ => Share.Default);
        services.TryAddScoped<ISms>(_ => Sms.Default);
        services.TryAddScoped<ITextToSpeech>(_ => TextToSpeech.Default);
